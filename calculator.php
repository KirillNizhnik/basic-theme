...
<section class="calculator" id="calculator-head">
    <div class="container">
...
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/1.png" alt=""-->
...
<!--                        </li>-->
<!--                        <li class="calculator-response-chacroanalysis-item">-->
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/2.png" alt=""-->
<!--                                 class="calculator-response-chacroanalysis-item-img">-->
<!--                            <div class="calculator-response-chacroanalysis-item-text">-->
<!--                                Aджна-->
<!--                            </div>-->
...
<!--                        </li>-->
<!--                        <li class="calculator-response-chacroanalysis-item">-->
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/3.png" alt=""-->
<!--                                 class="calculator-response-chacroanalysis-item-img">-->
<!--                            <div class="calculator-response-chacroanalysis-item-text">-->
<!--                                Вішудха-->
<!--                            </div>-->
...
<!--                        </li>-->
<!--                        <li class="calculator-response-chacroanalysis-item">-->
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/4.png" alt=""-->
<!--                                 class="calculator-response-chacroanalysis-item-img">-->
<!--                            <div class="calculator-response-chacroanalysis-item-text">-->
<!--                                Анахата-->
<!--                            </div>-->
...
<!--                        </li>-->
<!--                        <li class="calculator-response-chacroanalysis-item">-->
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/5.png" alt=""-->
<!--                                 class="calculator-response-chacroanalysis-item-img">-->
<!--                            <div class="calculator-response-chacroanalysis-item-text">-->
<!--                                Маніпура-->
<!--                            </div>-->
...
<!--                        </li>-->
<!--                        <li class="calculator-response-chacroanalysis-item">-->
<!--                            <img src="--><?php //= get_template_directory_uri() ?><!--/assets/images/7.png" alt=""-->
<!--                                 class="calculator-response-chacroanalysis-item-img">-->
<!--                            <div class="calculator-response-chacroanalysis-item-text">-->
<!--                                Муладхара-->
<!--                            </div>-->
